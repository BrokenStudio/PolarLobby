...
public class Cloth_Purple extends AbstractCosmetic {

    public Cloth_Purple() {
        super("Lila Kleidung", "Lila ist toll!", CosmeticType.CLOTH, new PolarItem(Material.LEATHER_CHESTPLATE).color(Color.PURPLE), Rarity.ULTIMATE);
    }
    ...
    public void select(Player player) {
        ...
        player.getInventory().setChestplate(new PolarItem(Material.LEATHER_CHESTPLATE).color(Color.PURPLE).name("§8•● " + getRarity().color() + getName() + " §8●•"));
        player.getInventory().setLeggings(new PolarItem(Material.LEATHER_LEGGINGS).color(Color.PURPLE).name("§8•● " + getRarity().color() + getName() + " §8●•"));
        player.getInventory().setBoots(new PolarItem(Material.LEATHER_BOOTS).color(Color.PURPLE).name("§8•● " + getRarity().color() + getName() + " §8●•"));
    }
