...
public class Particle_Red extends AbstractCosmetic {
    ...
    public void use(Player player) {
        ...
        Item one = location.getWorld().dropItem(location,new ItemStack(Material.RED_DYE));
        Item two = location.getWorld().dropItem(location,new ItemStack(Material.RED_STAINED_GLASS));
        Item three = location.getWorld().dropItem(location,new ItemStack(Material.RED_WOOL));
        Item four = location.getWorld().dropItem(location,new ItemStack(Material.RED_CONCRETE));
