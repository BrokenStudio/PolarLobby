package dev.brokenstudio.polarlobby.inventories.opener;
...
public class SpecialInventoryOpener implements InventoryOpener {
    ...
    @Override
    public Inventory open(PolarInventory inv, Player player) {
        InventoryManager manager = inv.getInventoryManager();
