...
public class Cloth_Blue extends AbstractCosmetic {

    public Cloth_Blue() {
        super("Blaue Kleidung", "Ein blaues Wunder erleben", CosmeticType.CLOTH, new PolarItem(Material.LEATHER_CHESTPLATE).color(Color.BLUE), Rarity.EPIC);
    }
    ...
    public void select(Player player) {
        ...
        player.getInventory().setChestplate(new PolarItem(Material.LEATHER_CHESTPLATE).color(Color.BLUE).name("§8•● " + getRarity().color() + getName() + " §8●•"));
        ...
        player.getInventory().setBoots(new PolarItem(Material.LEATHER_BOOTS).color(Color.BLUE).name("§8•● " + getRarity().color() + getName() + " §8●•"));
    }
