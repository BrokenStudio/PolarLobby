...
public class Particle_Green extends AbstractCosmetic {
    ...
    public void use(Player player) {
        ...
        Item one = location.getWorld().dropItem(location,new ItemStack(Material.GREEN_DYE));
        Item two = location.getWorld().dropItem(location,new ItemStack(Material.GREEN_STAINED_GLASS));
        Item three = location.getWorld().dropItem(location,new ItemStack(Material.GREEN_WOOL));
        Item four = location.getWorld().dropItem(location,new ItemStack(Material.GREEN_CONCRETE));
