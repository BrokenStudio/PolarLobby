...
public class Particle_Commandblock extends AbstractCosmetic {
    ...
    public void use(Player player) {
        ...
        Item one = location.getWorld().dropItem(location,new ItemStack(Material.COMMAND_BLOCK));
        Item two = location.getWorld().dropItem(location,new ItemStack(Material.CHAIN_COMMAND_BLOCK));
        Item three = location.getWorld().dropItem(location,new ItemStack(Material.REPEATING_COMMAND_BLOCK));
